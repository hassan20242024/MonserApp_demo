...
#import dj_database_url #Variable de entorno. pip install python-decouple dj-database-url
#from dotenv import load_dotenv #pip install python-dotenv USADA PARA SQLSERVER
#load_dotenv()
...
#BASE DE DATOS PARA SQLSERVER PROCAPS SIN VARIABLE DE ENTRONO
#DATABASES = {
 #  'default': {
  #      'ENGINE': 'mssql',
   #     'NAME': 'LAB_SERVITEC',
...
#BASE DE DATOS DE POSGRESSQL DE RENDER CON VARIABLE DE ENTORNO (.ENV)
...
#BASE DE DATOS PARA SQLSERVER PROCAPS CON VARIABLE DE ENTORNO (.ENV)
#DATABASES = {
