  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const btnNuevo = document.getElementById('btn-nuevo-protocolo');
    if (btnNuevo) {
    ...
    document.addEventListener('click', function (e) {
      const btnEditar = e.target.closest('.btn-editar-protocolo');
      if (btnEditar) {
        e.preventDefault();
        ...
        document.addEventListener('click', function (e) {
      const btnEditar = e.target.closest('.btn-crear-protocolo-sidebar');
      if (btnEditar) {
        e.preventDefault();
        mostrarSwalYRedirigir(btnEditar.href);
      }
